window.GlobalBasketData = {
  ...
  categories: [
    {
      ...
      href: "/catalog/?category=premium-nuts",
      status: "active",
    ...
    },
    {
      ...
      href: "/catalog/?category=dried-fruits",
      status: "coming",
      statusLabel: "Скоро",
    },
    {
      ...
      href: "/catalog/?category=nut-mixes",
      status: "coming",
      statusLabel: "Скоро",
    },
    {
  ...
  home: {
    hero: {
      ...
      image: {
        src: "/assets/home/global-basket-hero-portrait.png",
  ...
  utilityPages: {
    ...
    account: {
      ...
      primary: { label: "Сохранить аккаунт", href: "/account/#account-register" },
      secondary: { label: "Открыть каталог", href: "/catalog/" },
      highlights: [
    ...
    cart: {
      ...
      primary: { label: "Сохранить в аккаунт", href: "/account/#account-register" },
    ...
    story: [
      {
        ...
        image: "/assets/delivery/globalbasket-origin-harvest.jpg",
      ...
      },
      {
        ...
        image: "/assets/delivery/globalbasket-sea-logistics.jpg",
      ...
      },
      {
        ...
        image: "/assets/delivery/globalbasket-warehouse-packing.jpg",
      ...
      },
      {
        ...
        image: "/assets/delivery/globalbasket-ozon-delivery.jpg",
    ...
    posts: [
      {
        ...
        image: "/assets/journal/packaging-preview.png",
        lead:
      ...
      },
      {
        ...
        image: "/assets/journal/macadamia-start-preview.png",
        lead:
        ...
        },
      {
        ...
        image: "/assets/journal/catalog-growth-preview.png",
        lead:
    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Премиальные орехи", href: "/catalog/?category=premium-nuts" },
...
const productsFromPack = catalogPayload.products_cards
  ...
  .map((card) => {
    ...
    return {
      ...
      categoryHref: `/catalog/?category=${cleanText(card.category_slug)}`,
...
const categoriesFromPack = catalogPayload.categories
  ...
  .map((item) => ({
    ...
    href: `/catalog/?category=${cleanText(item.category_slug)}`,
