window.GlobalBasketData = {
  ...
  utilityPages: {
    ...
    account: {
      title: "Аккаунт",
      text: "Сохраните один удобный контакт, чтобы держать в одном месте корзину, избранное и свои товарные предпочтения.",
      ...
      formText:
        "Укажите один удобный канал связи. Профиль сохранит корзину, избранное и предпочтения, которые вы соберёте на сайте.",
      consent:
      ...
      registeredTitle: "Аккаунт уже сохранён",
      registeredText:
        "Профиль можно обновить в любой момент. После сохранения корзина, избранное и интересующие разделы привязываются к этому браузеру.",
    },
    cart: {
      title: "Корзина",
