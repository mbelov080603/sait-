window.GlobalBasketData = {
  ...
  contactsPage: {
    intro:
      "Оставьте запрос на поставку, укажите объём и адрес доставки — на странице сразу появится предварительный расчёт. После отправки заявка попадёт команде Global Basket в Telegram, а при необходимости можно сразу написать нам напрямую.",
    leftCards: [
      {
        title: "Розница",
    ...
    quoteForm: {
      ...
      text:
        "Заполните короткую форму для закупки: укажите компанию, объём и адрес доставки. Предварительная стоимость обновится по мере заполнения.",
      ...
      pricingHint:
        "Базовая цена — 700 ₽/кг. От 100 кг действует скидка 10%, от 500 кг — 15%, от 1000 кг — 20%. За каждые полные 1000 км от Москвы добавляется 5% к сумме. Расстояние можно указать ориентировочно — финально уточним его вместе с вами.",
      consent:
