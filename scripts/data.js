window.GlobalBasketData = {
  ...
  home: {
    intro: {
      title: "Global Basket",
      text:
        "Сайт говорит тем же языком, что и фирменная упаковка: теплая бумажная фактура, янтарные акценты, бордовый текст и честная продуктовая подача.",
    },
    quickCategories: [
    ...
    merchBand: [
      ...
      {
        eyebrow: "Бренд",
        title: "Пергаментный фон, янтарная графика и бордовый акцент",
        text: "В интерфейсе сайта айдентика работает как система, а не как одна картинка в hero.",
        href: "/about/",
        cta: "О бренде",
      },
    ],
    banners: [
      {
        ...
        text: "Чистый состав, вакуумная упаковка и фирменная теплая палитра Global Basket для главной витрины магазина.",
        image: "/assets/catalog-front.png",
        href: "/catalog/macadamia/",
        cta: "Карточка товара",
        ribbon: "Переносим в сайт текстуру упаковки, золотистую корзину и темный бордовый ритм бренда",
      },
      {
        variant: "side",
  ...
  aboutPage: {
    hero:
      "Global Basket строится как премиальный food-бренд: с пергаментной фактурой, янтарной графикой, бордовым текстом и понятной магазинной структурой.",
    pillars: [
      {
        title: "Собственный визуальный язык",
        text: "Пергаментный фон, золотисто-янтарная графика и темный бордовый текст создают узнаваемую подачу без копирования чужих магазинов.",
      },
      {
      ...
      {
        title: "Опора на фирменную графику и реальные фото",
        text: "Упаковка, бренд-постер, lifestyle и продуктовая фактура работают как полноценные merchandising-блоки.",
      },
      {
