window.GlobalBasketData = {
  ...
  trustCards: [
    ...
    {
      title: "Возвраты",
      text: "Вопросы по возвратам и сопровождению заказа решаем через контакты.",
      href: "/sait-/contacts/?source=returns",
    },
  ],
  home: {
    hero: {
  ...
  utilityPages: {
    ...
    account: {
      title: "Аккаунт",
      text: "Личный кабинет готовится. Пока корзина и избранное сохраняются в этом браузере, а регистрацию аккуратно откроем позже.",
      primary: { label: "Статус регистрации", href: "/sait-/account/#account-register" },
      secondary: { label: "Открыть каталог", href: "/sait-/catalog/" },
      highlights: [
        "Регистрация готовится",
        "Корзина и избранное остаются в браузере",
        "Заказы доступны через форму связи",
      ],
      formTitle: "Регистрация скоро станет возможна",
      formText:
        "Мы временно отключили создание аккаунта и готовим личный кабинет к спокойному запуску.",
      consent:
        'Даю согласие ООО «ВОСТОК ИМПОРТ ПРОМ» на обработку моих персональных данных на условиях <a href="/sait-/legal/globalbasket_personal_data_consent.pdf" target="_blank" rel="noopener noreferrer">Согласия на обработку персональных данных</a> и подтверждаю ознакомление с <a href="/sait-/legal/globalbasket_privacy_policy.pdf" target="_blank" rel="noopener noreferrer">Политикой обработки персональных данных</a>.',
  ...
  deliveryPage: {
    steps: [
      ...
      },
      {
        ...
        text: "Наш менеджер свяжется с Вами и уточнит все детали.",
      },
      {
        title: "3. Согласуем дальнейшее взаимодействие",
        text: "Определим удобный формат поставки и следующий шаг по закупке.",
      },
    ],
    cards: [
      ...
      { title: "Доставка и закупка", text: "Подберём подходящий вариант доставки и отдельно обсудим условия регулярной или оптовой закупки." },
    ],
    story: [
      {
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Возвраты", href: "/sait-/contacts/?source=returns" },
        ],
      },
      {
        title: "Документы",
