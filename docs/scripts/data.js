window.GlobalBasketData = {
  ...
  deliveryPage: {
    ...
    story: [
      {
        badge: "Источник",
        title: "Отбор у происхождения",
        text: "Поставки начинаются с понятного происхождения продукта и аккуратного отбора сырья до следующего логистического этапа.",
        image: "/sait-/assets/delivery/globalbasket-origin-harvest.jpg",
        alt: "Сбор урожая у источника поставки Global Basket",
      },
      {
        badge: "Логистика",
        title: "Международная перевозка",
        text: "Для крупных партий логистика собирается под маршрут поставки: контейнерная линия, сроки и сопровождение без лишней путаницы.",
        image: "/sait-/assets/delivery/globalbasket-sea-logistics.jpg",
        alt: "Контейнерная поставка Global Basket в морском порту",
      },
      {
        badge: "Склад",
        title: "Сборка и маркировка",
        text: "На складе товар проходит спокойную и предсказуемую сборку: упаковка, маркировка, подготовка к отгрузке и проверка комплектации.",
        image: "/sait-/assets/delivery/globalbasket-warehouse-packing.jpg",
        alt: "Складская сборка и упаковка заказов Global Basket",
      },
      {
        badge: "Последняя миля",
        title: "Передача в канал доставки",
        text: "После сборки отправка уходит в нужный сценарий: маркетплейс, розничная поставка или отдельная точка получения под заказ клиента.",
        image: "/sait-/assets/delivery/globalbasket-ozon-delivery.jpg",
        alt: "Грузовик Global Basket у распределительного центра Ozon",
      },
    ],
    returns: {
