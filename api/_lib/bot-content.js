...
const WELCOME_TEXT =
  "Здравствуйте! Это бот Global Basket. Здесь можно быстро перейти к маркетплейсам, открыть канал бренда, узнать о компании и написать нам напрямую. Если бот уже открыт у пользователя, новые посты из канала можно дублировать сюда автоматически.";
